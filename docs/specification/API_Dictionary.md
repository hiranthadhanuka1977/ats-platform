...
| [**api/backoffice-applications.md**](api/backoffice-applications.md) | Staff pipeline: status PATCH, undo, reopen, interviews, relevance score, CV/cover-letter download |
...
| **Backoffice (Next.js)** | App-local **`/api/auth/*`**, **`/api/backoffice/*`**, **`/api/admin/*`** on the staff app (port **3001**) — applications detail in [api/backoffice-applications.md](api/backoffice-applications.md) |
