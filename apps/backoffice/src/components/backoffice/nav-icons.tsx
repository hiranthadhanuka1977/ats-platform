...
export function IconInterviews(props: SVGProps<SVGSVGElement>) {
  return (
    <svg className="bo-nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} aria-hidden {...props}>
...
export function IconAdministration(props: SVGProps<SVGSVGElement>) {
  return (
    <svg className="bo-nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} aria-hidden {...props}>
...
/** Kanban / pipeline columns layout. */
export function IconLayoutKanban(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      width={18}
      height={18}
...
/** Web / public-style job preview (opens in new tab). */
